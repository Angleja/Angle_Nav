...
- [部署方式](#部署方式)
  - [快速部署到GitHub Pages](#快速部署到github-pages)
    ...
    - [第二步：自定义配置](#第二步自定义配置)
  - [部署到服务器](#部署到服务器)
  - [其他CI/CD托管选项](#其他cicd托管选项)
- [设置模块化配置文件](#设置模块化配置文件)
  - [使用配置](#使用配置)
  - [配置详解](#配置详解)
  - [一、site.yml 配置文件](#一siteyml-配置文件)
  - [二、navigation.yml 配置文件](#二navigationyml-配置文件)
  - [三、pages目录 配置文件](#三pages目录-配置文件)
  - [四、Font Awesome图标指南](#四font-awesome图标指南)
  - [五、配置文件结构示例](#五配置文件结构示例)
  - [六、常见配置问题解决](#六常见配置问题解决)
- [书签导入功能](#书签导入功能)
  - [MarksVault 浏览器扩展集成](#marksvault-浏览器扩展集成)
  - [配置加载优先级](#配置加载优先级)
  - [导入步骤详解](#导入步骤详解)
    - [使用 MarksVault 浏览器扩展（推荐）](#使用-marksvault-浏览器扩展推荐)
    - [手动导入](#手动导入)
  - [书签导入注意事项](#书签导入注意事项)
- [常见问题](#常见问题)
